...
public class ArrayPage {
	...
	private WebElement writePractQueCode;
	@FindBy(id = "output")
	...
	private WebElement PracticeQuesOfArray;
	...
	public void writeCode(String code) {
		...
		// get HTML element document.querySelector('.CodeMirror') & reference to the
		// actual CodeMirror editor instance. Stores code-mirror editor instance to
		// editor variable.

		js.executeScript(
				"let editor = document.querySelector('.CodeMirror').CodeMirror;" + "editor.setValue(arguments[0]);",
				code); // passing code as a parameter rather than hardcoding it inside the JS
