...
public class LinkedListTest extends Hooks{
	...
	public void validCodeTest(String validCode, String expectedResults) {
		...
		if(pfm.getLinkedListPage().isOutputSuccess()) {
			assertTrue(pfm.getLinkedListPage().isOutputSuccess(), "Success output not shown as expected: " +expectedResults);
	...
	public void practiceQuePage() {
		...
		softAssert.assertTrue(pfm.getLinkedListPage().checkPracticeQueContent(), "Found the page blank. Expected to have List of Practice Questions");		
